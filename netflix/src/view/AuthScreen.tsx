  ...
  return (
    <div className='hero-bg relative'>
      ...
      <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
        ...
        <button className='bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center' onSubmit={handleSubmit}>Get started!<ChevronRight className='size-8 md:size-10' /></button>
        </form>
      </div>
        ...
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
          <div className='flex-1 text-center md:text-left'>
            ...
            <p className='text-lg md:text-xl'>
              Watch on SmartTV, PlayStation, Xbox, Chromecast, Apple TV, Blu-ray, players and more.
            </p>
          </div>
        ...
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
          <div className='flex-1 relative'>
            <div className='relative'>
              <img src='/stranger-things-lg.png' alt='Stranger images' className='mt-4' />

              <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 
              bg-black w-3/4 lg:w-1/2 h-25 border border-slate-500 rounded-md px-2'>
      ...
      <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
          <div className='flex-1 relative '>
            <img src='/kids.png' alt='tv' className='mt-4' />
          </div>
          <div className='flex-1 text-center md:text-left'>
